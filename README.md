...
🚀 Prise en Main
Prérequis
Microsoft Power BI Desktop (gratuit)
...
Ouvrir avito.pbix dans Power BI Desktop
Utiliser les onglets en bas : Vue Globale → Analyse des prix → Analyse Géographique
Appliquer les filtres dans le panneau gauche pour affiner l'analyse
📂 Fichiers du Projet
